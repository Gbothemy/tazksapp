  ...
  return (
    <div style={{ marginTop: 48 }}>
      <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 8 }}>
        <h2 style={{ margin: 0, fontSize: 20, fontWeight: 700, color: "#1a2e1c" }}>Data Management</h2>
      ...
      {result && (
        <div style={{
          ...
          border: `1px solid ${result.ok ? "#c8e6cc" : "#f5a0a0"}`,
          borderRadius: 10, padding: "12px 16px", marginBottom: 20,
          display: "flex", alignItems: "center", gap: 10,
        }}>
          <span style={{ fontSize: 18 }}>{result.ok ? "✅" : "⚠️"}</span>
              ...
              <div style={{ display: "flex", alignItems: "flex-start", gap: 12, marginBottom: 12 }}>
                ...
                <div style={{ flex: 1 }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 4 }}>
                    <p style={{ margin: 0, fontWeight: 700, fontSize: 14, color: "#1a2e1c" }}>{opt.label}</p>
