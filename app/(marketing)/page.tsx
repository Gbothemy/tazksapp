    ...
    <div style={{ background: "#fff", color: "#1A1A1A", overflowX: "hidden" }}>
      ...
      <nav style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          <div style={{ width: 36, height: 36, borderRadius: 10, background: "linear-gradient(135deg, #1AEF22, #06B517)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 18, boxShadow: "0 4px 12px rgba(75,127,82,0.3)" }}>?</div>
      ...
      <section style={{ background: "linear-gradient(160deg, #1AEF22 0%, #06B517 55%, #058f12 100%)", padding: "80px 5vw 100px", position: "relative", overflow: "hidden", textAlign: "center" }}>
        ...
        <div style={{ display: "flex", gap: 14, justifyContent: "center", flexWrap: "wrap" }}>
          <Link href="/register" style={{ background: "linear-gradient(135deg, #F5A623, #d89420)", color: "#fff", textDecoration: "none", padding: "16px 36px", borderRadius: 14, fontWeight: 800, fontSize: 16, boxShadow: "0 8px 28px rgba(212,175,55,0.4)" }}>
            Start Earning Free ?
          </Link>
      ...
      <section style={{ background: "linear-gradient(135deg, #1AEF22 0%, #06B517 60%, #058f12 100%)", padding: "80px 5vw", textAlign: "center", position: "relative", overflow: "hidden" }}>
        ...
        <Link href="/register" style={{ background: "linear-gradient(135deg, #F5A623, #d89420)", color: "#fff", textDecoration: "none", padding: "18px 44px", borderRadius: 14, fontWeight: 800, fontSize: 17, boxShadow: "0 8px 28px rgba(212,175,55,0.4)", display: "inline-block", position: "relative" }}>
          Create Free Account ?
        </Link>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: 32, marginBottom: 40 }}>
            <div>
              <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 12 }}>
                <div style={{ width: 32, height: 32, borderRadius: 8, background: "linear-gradient(135deg, #1AEF22, #06B517)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 16 }}>?</div>
