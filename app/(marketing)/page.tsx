  ...
  return (
    <div style={{ background: "#fff", color: "#1A1A1A", overflowX: "hidden" }}>
      ...
      <nav style={{
        ...
        borderBottom: "1px solid #e8e8e8", padding: "0 5vw",
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          />
          <span style={{ fontWeight: 800, fontSize: 18, letterSpacing: -0.5, color: "#1A1A1A" }}>Qeixova</span>
        </div>
      ...
      <section style={{ background: "linear-gradient(160deg, #1AEF22 0%, #06B517 55%, #058f12 100%)", padding: "80px 5vw 100px", position: "relative", overflow: "hidden", textAlign: "center" }}>
        <div style={{ position: "absolute", top: -80, right: -80, width: 400, height: 400, borderRadius: "50%", background: "rgba(245,166,35,0.08)" }} />
        <div style={{ position: "absolute", bottom: -60, left: -60, width: 300, height: 300, borderRadius: "50%", background: "rgba(255,255,255,0.04)" }} />

        <div style={{ display: "inline-flex", alignItems: "center", gap: 6, background: "rgba(245,166,35,0.15)", border: "1px solid rgba(245,166,35,0.3)", borderRadius: 20, padding: "6px 16px", marginBottom: 28 }}>
          <span>🔥</span>
          <span style={{ color: "#F5A623", fontSize: 13, fontWeight: 700 }}>50,000+ Nigerians already earning</span>
        </div>
        ...
        <h1 style={{ color: "#fff", fontSize: "clamp(32px, 6vw, 64px)", fontWeight: 900, lineHeight: 1.1, letterSpacing: -2, maxWidth: 760, margin: "0 auto 20px" }}>
          ...
          <span style={{ background: "linear-gradient(90deg, #F5A623, #F5A623)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>
        ...
        <p style={{ color: "rgba(255,255,255,0.75)", fontSize: "clamp(15px, 2vw, 19px)", maxWidth: 560, margin: "0 auto 16px", lineHeight: 1.6 }}>
          Qeixova rewards you with <strong style={{ color: "#F5A623" }}>QLT Points (Qeixova Loyalty Token)</strong> for completing simple online tasks. Accumulate QLT and convert to Naira whenever you want.
        </p>
        ...
        <div style={{ display: "inline-flex", alignItems: "center", gap: 10, background: "rgba(255,255,255,0.1)", border: "1px solid rgba(255,255,255,0.2)", borderRadius: 14, padding: "10px 20px", marginBottom: 36 }}>
          ...
          <span style={{ color: "#F5A623", fontSize: 14, fontWeight: 700 }}>₦1</span>
          <span style={{ color: "rgba(255,255,255,0.5)", fontSize: 12 }}>· Instant conversion</span>
        </div>

        <div style={{ display: "flex", gap: 14, justifyContent: "center", flexWrap: "wrap" }}>
          <Link href="/register" style={{ background: "linear-gradient(135deg, #F5A623, #d89420)", color: "#fff", textDecoration: "none", padding: "16px 36px", borderRadius: 14, fontWeight: 800, fontSize: 16, boxShadow: "0 8px 28px rgba(245,166,35,0.4)" }}>
            Start Earning Free ?
          </Link>
      ...
      <section style={{ background: "#1A1A1A", padding: "36px 5vw" }}>
      ...
      {/* -- STATS -- */}
      <section style={{ background: "#fff", borderBottom: "1px solid #e8e8e8", padding: "48px 5vw" }}>
        <div style={{ maxWidth: 900, margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(160px, 1fr))", gap: 24, textAlign: "center" }}>
          {stats.map((s) => (
            <div key={s.label}>
              ...
              <p style={{ fontSize: 13, color: "#a0a0a0", marginTop: 6, fontWeight: 500 }}>{s.label}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      {/* -- FEATURES -- */}
      <section style={{ padding: "80px 5vw", background: "#F5F5F5" }}>
        <div style={{ maxWidth: 960, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 52 }}>
            <span style={{ fontSize: 12, fontWeight: 700, color: "#1AEF22", letterSpacing: 2, textTransform: "uppercase", background: "#e8ffe9", borderRadius: 20, padding: "4px 14px" }}>What you can do</span>
            <h2 style={{ fontSize: "clamp(26px, 4vw, 42px)", fontWeight: 900, color: "#1A1A1A", marginTop: 14, letterSpacing: -1 }}>Four ways to earn points every day</h2>
          </div>
            ...
            {features.map((f) => (
              <div key={f.title} style={{ background: "#fff", borderRadius: 20, padding: "28px 24px", boxShadow: "0 4px 20px rgba(26,239,34,0.07)", border: "1px solid #e8e8e8" }}>
                ...
                <div style={{ display: "inline-flex", alignItems: "center", gap: 6, background: "#fdf8e1", borderRadius: 8, padding: "5px 12px" }}>
                  ...
                  <span style={{ fontSize: 12, fontWeight: 700, color: "#d89420" }}>{f.earn} per task</span>
                </div>
              </div>
            ))}
          </div>
      ...
      <section id="how-it-works" style={{ padding: "80px 5vw", background: "#fff" }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 52 }}>
            <span style={{ fontSize: 12, fontWeight: 700, color: "#1AEF22", letterSpacing: 2, textTransform: "uppercase", background: "#e8ffe9", borderRadius: 20, padding: "4px 14px" }}>Simple process</span>
            <h2 style={{ fontSize: "clamp(26px, 4vw, 42px)", fontWeight: 900, color: "#1A1A1A", marginTop: 14, letterSpacing: -1 }}>Up and earning in 4 steps</h2>
          </div>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: 32 }}>
            {steps.map((step) => (
              <div key={step.num} style={{ textAlign: "center" }}>
                ...
                <h3 style={{ fontWeight: 700, fontSize: 15, color: "#1A1A1A", marginBottom: 8 }}>{step.title}</h3>
      ...
      <section style={{ padding: "80px 5vw", background: "#F5F5F5" }}>
        <div style={{ maxWidth: 960, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 52 }}>
            <span style={{ fontSize: 12, fontWeight: 700, color: "#1AEF22", letterSpacing: 2, textTransform: "uppercase", background: "#e8ffe9", borderRadius: 20, padding: "4px 14px" }}>Real earners</span>
            <h2 style={{ fontSize: "clamp(26px, 4vw, 42px)", fontWeight: 900, color: "#1A1A1A", marginTop: 14, letterSpacing: -1 }}>People just like you are earning</h2>
          </div>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: 20 }}>
            {testimonials.map((t) => (
              <div key={t.name} style={{ background: "#fff", borderRadius: 20, padding: "28px 24px", boxShadow: "0 4px 20px rgba(26,239,34,0.07)", border: "1px solid #e8e8e8" }}>
                ...
                <p style={{ fontSize: 14, color: "#3a3a3a", lineHeight: 1.7, marginBottom: 20, fontStyle: "italic" }}>&ldquo;{t.text}&rdquo;</p>
                <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                  <div style={{ width: 44, height: 44, borderRadius: "50%", background: "linear-gradient(135deg, #e8ffe9, #b3f5b6)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 22 }}>{t.avatar}</div>
                  <div>
                    <p style={{ fontWeight: 700, fontSize: 14, color: "#1A1A1A" }}>{t.name}</p>
                    <p style={{ fontSize: 12, color: "#a0a0a0" }}>{t.role}</p>
                  </div>
                </div>
              </div>
            ))}
      ...
      <section style={{ padding: "80px 5vw", background: "#fff" }}>
        <div style={{ maxWidth: 680, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 48 }}>
            <span style={{ fontSize: 12, fontWeight: 700, color: "#1AEF22", letterSpacing: 2, textTransform: "uppercase", background: "#e8ffe9", borderRadius: 20, padding: "4px 14px" }}>FAQ</span>
            <h2 style={{ fontSize: "clamp(24px, 4vw, 38px)", fontWeight: 900, color: "#1A1A1A", marginTop: 14, letterSpacing: -1 }}>Common questions</h2>
          </div>
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            {faqs.map((faq, i) => (
              <div key={i} style={{ background: openFaq === i ? "#fafafa" : "#fff", border: `1.5px solid ${openFaq === i ? "#b3f5b6" : "#e8e8e8"}`, borderRadius: 16, overflow: "hidden", transition: "all 0.2s" }}>
                <button onClick={() => setOpenFaq(openFaq === i ? null : i)} style={{ width: "100%", padding: "18px 20px", display: "flex", justifyContent: "space-between", alignItems: "center", background: "none", border: "none", cursor: "pointer", textAlign: "left" }}>
                  ...
                  <span style={{ width: 28, height: 28, borderRadius: 8, background: openFaq === i ? "#1AEF22" : "#F5F5F5", display: "flex", alignItems: "center", justifyContent: "center", color: openFaq === i ? "#fff" : "#6b6b6b", fontSize: 18, fontWeight: 700, flexShrink: 0, transition: "all 0.2s" }}>
                    {openFaq === i ? "-" : "+"}
                  </span>
                </button>
                {openFaq === i && <p style={{ padding: "0 20px 18px", fontSize: 14, color: "#6b6b6b", lineHeight: 1.7 }}>{faq.a}</p>}
              </div>
            ))}
          </div>
        </div>
      ...
      <section style={{ background: "linear-gradient(135deg, #1AEF22 0%, #06B517 60%, #058f12 100%)", padding: "80px 5vw", textAlign: "center", position: "relative", overflow: "hidden" }}>
        <div style={{ position: "absolute", top: -60, right: -60, width: 280, height: 280, borderRadius: "50%", background: "rgba(245,166,35,0.1)" }} />
        ...
        <Link href="/register" style={{ background: "linear-gradient(135deg, #F5A623, #d89420)", color: "#fff", textDecoration: "none", padding: "18px 44px", borderRadius: 14, fontWeight: 800, fontSize: 17, boxShadow: "0 8px 28px rgba(245,166,35,0.4)", display: "inline-block", position: "relative" }}>
          Create Free Account →
        </Link>
      ...
      {/* -- FOOTER -- */}
      <footer style={{ background: "#1A1A1A", padding: "48px 5vw 32px", color: "rgba(255,255,255,0.6)" }}>
        <div style={{ maxWidth: 960, margin: "0 auto" }}>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: 32, marginBottom: 40 }}>
            <div>
              ...
              <div style={{ marginTop: 14, display: "inline-flex", alignItems: "center", gap: 6, background: "rgba(245,166,35,0.15)", border: "1px solid rgba(245,166,35,0.25)", borderRadius: 8, padding: "6px 12px" }}>
                <span style={{ fontSize: 14 }}>⭐</span>
            ...
            <div>
              ...
              {["How it works", "Task categories", "Points & rewards", "Referral program"].map((l) => (
                <p key={l} style={{ fontSize: 13, marginBottom: 10, cursor: "pointer" }} onMouseEnter={(e) => (e.currentTarget.style.color = "#F5A623")} onMouseLeave={(e) => (e.currentTarget.style.color = "rgba(255,255,255,0.6)")}>{l}</p>
              ))}
            </div>
            <div>
