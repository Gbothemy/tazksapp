  ...
  return (
    <div className="page-body" style={{ background: "#f2f2f2", minHeight: "100vh" }}>
      <div className="page-header" style={{
        ...
        <p style={{ color: "rgba(255,255,255,0.7)", fontSize: 13, marginBottom: 4 }}>Available Balance</p>
        <p style={{ color: "#fff", fontSize: 40, fontWeight: 800, letterSpacing: -2, lineHeight: 1 }}>
          ₦{balance.toLocaleString()}
        </p>
        <div style={{ display: "flex", gap: 10, marginTop: 18 }}>
          {[{ label: "Min. Withdrawal", value: "₦1,000" }, { label: "Processing", value: "Instant" }, { label: "Fee", value: "Free" }].map((item) => (
        ...
        <div style={{ padding: "20px 16px 0" }}>
          <div style={{ background: "#fff", borderRadius: 20, padding: "22px 20px", boxShadow: "0 4px 20px rgba(75,127,82,0.10)", border: "1px solid #edf2ee" }}>
            ...
            <form onSubmit={handleWithdraw} style={{ display: "flex", flexDirection: "column", gap: 14 }}>
              <div>
                <label style={{ fontSize: 12, color: "#6b7c6d", fontWeight: 700, letterSpacing: 0.5 }}>AMOUNT (₦)</label>
                <input type="number" value={amount} onChange={(e) => setAmount(e.target.value)} placeholder="Min. ₦1,000"
                  style={{ width: "100%", marginTop: 8, padding: "14px 16px", borderRadius: 12, border: "1.5px solid #e0e8e1", fontSize: 16, outline: "none", color: "#1a2e1c", background: "#f9fbf9" }}
              ...
              {transactions.map((tx, i) => (
                <div key={i} style={{ background: "#fff", borderRadius: 16, padding: "14px 16px", display: "flex", justifyContent: "space-between", alignItems: "center", boxShadow: "0 2px 8px rgba(75,127,82,0.06)", border: "1px solid #edf2ee" }}>
                  ...
                  <div style={{ background: tx.type === "credit" ? "#edf7ee" : "#fff5f5", borderRadius: 10, padding: "5px 12px" }}>
                    <p style={{ fontWeight: 800, fontSize: 14, color: tx.type === "credit" ? "#4b7f52" : "#e53e3e" }}>
