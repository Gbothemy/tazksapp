    ...
    <div className="page-body" style={{ background: "#F5F5F5", minHeight: "100vh" }}>
      ...
      <div style={{ padding: "20px 16px 0" }}>
        <div style={{ display: "flex", gap: 12 }}>
          ...
          <Link href="/tasks" style={{
            flex: 1, background: "linear-gradient(135deg, #F5A623, #d89420)", color: "#fff",
            borderRadius: 14, padding: "14px 0", textAlign: "center", fontWeight: 700, fontSize: 14,
      ...
      <div style={{ padding: "28px 16px 0" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 16 }}>
          <p style={{ fontWeight: 800, fontSize: 17, color: "#1A1A1A" }}>Task Categories</p>
          ...
          {categories.map((cat) => (
            <Link key={cat.label} href="/tasks" style={{ textDecoration: "none" }}>
              <div style={{ background: "#ffffff", borderRadius: 18, padding: "18px 16px", boxShadow: "0 2px 12px rgba(26,239,34,0.07)", border: "1px solid #e8e8e8" }}>
                ...
                <p style={{ fontWeight: 700, fontSize: 13, color: "#1A1A1A", marginBottom: 3 }}>{cat.label}</p>
                <p style={{ fontSize: 11, fontWeight: 700, color: "#F5A623", background: "#fdf8e1", borderRadius: 6, padding: "2px 8px", display: "inline-block" }}>{cat.earn}</p>
              </div>
            </Link>
          ))}
        </div>
      ...
      {/* Recent Activity */}
      <div style={{ padding: "28px 16px 0" }}>
        <p style={{ fontWeight: 800, fontSize: 17, color: "#1A1A1A", marginBottom: 16 }}>Recent Activity</p>
              ...
              <div key={i} style={{
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                  ...
                  <div>
                    ...
                    <p style={{ fontSize: 11, color: "#a0a0a0", marginTop: 2 }}>{timeAgo(tx.created_at)}</p>
                  </div>
                </div>
