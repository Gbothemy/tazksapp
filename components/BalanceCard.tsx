  ...
  return (
    <div style={{
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 6 }}>
        <div>
          ...
          <div style={{ display: "flex", alignItems: "baseline", gap: 6 }}>
            ...
            <span style={{ fontSize: 13, opacity: 0.6 }}>QTL</span>
          </div>
        </div>
      ...
      <div style={{ background: "rgba(212,175,55,0.12)", border: "1px solid rgba(212,175,55,0.2)", borderRadius: 10, padding: "7px 12px", marginBottom: 18, display: "inline-flex", alignItems: "center", gap: 6 }}>
        ...
        <span style={{ fontSize: 11, opacity: 0.6 }}>cash value · 100 QTL = ₦1</span>
      </div>
      ...
      <div style={{ display: "flex" }}>
        <div style={{ flex: 1 }}>
          ...
          <p style={{ fontSize: 18, fontWeight: 700, color: "#e8c84a" }}>+{todayEarned.toLocaleString()} <span style={{ fontSize: 11 }}>QTL</span></p>
        </div>
